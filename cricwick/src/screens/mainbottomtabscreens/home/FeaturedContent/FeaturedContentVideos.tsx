...
import FeaturedContentCardVideo
	from "../../../../components/comp.mainbottomtabscreen/Home/Video/FeaturedContent/FeaturedContentCardVideo";
		...
		<View style={{
			...
			<View style={{backgroundColor: colors.card}}>
				...
				<View style={{
					...
					<Text style={{color: colors.text, fontWeight: 'bold'}}>{theTitle}</Text>
				</View>
				<View style={{
					marginHorizontal: 10,
					flexDirection: 'row',
					...
					<View style={{
						...
						<View style={{
							...
							<GoogleIcon name={'visibility'} size={20} color={Colors.textGray200}/>
							<Text
								style={{color: Colors.textGray200}}> {theViews > 1000 ? (theViews / 1000).toFixed(0) + 'k' : theViews}</Text>
						</View>
						<View style={{
							flexDirection: 'row',
							alignItems: 'center'
						}}>
							<GoogleIcon name={'thumb-up'} size={20} color={Colors.textGray200}/>
							<Text style={{color: Colors.textGray200}}> {theLikes}</Text>
						</View>
					</View>
					<TouchableOpacity>
						<GoogleIcon name={'share'} size={20} color={Colors.textGray200}/>
					</TouchableOpacity>
