        ...
        <View style={{
            ...
            <View style={{
                ...
                <View style={{
                    ...
                    <View>
                        <Text style={{color: 'black', fontWeight: 'bold', fontSize: 16}}>Batsmen</Text>
                    </View>
                    <View style={{
                        flexDirection: 'row',
                    }}>
                        <Text style={{color: 'black', fontSize: 12}}>Partnership of </Text>
                        <Text style={{
                            color: 'black',
                            fontSize: 12,
                            fontWeight: '500'
                        }}>{' ' + item.score_covered + ' '}</Text>
                        <Text style={{color: 'black', fontSize: 12}}>runs from</Text>
                        <Text style={{
                            color: 'black',
                            fontSize: 12,
                            fontWeight: '500'
                        }}>{' ' + convertOversToBalls(item.overs_played) + ' '}</Text>
                        <Text style={{color: 'black', fontSize: 12}}>balls</Text>
                    </View>
                </View>
                {item && item['batsman_1'] && < View style={{
                    ...
                    {item['batsman_1']['player'].name && <View style={{
                        ...
                        flexDirection: 'row',
                        alignItems: 'center',
                    }}><Text style={{color: 'black'}}>{item['batsman_1']['player'].short_name}</Text>
                    ...
                    {item['batsman_1']['batsman'] && <View style={{flexDirection: 'row', width: '77.7%'}}>
                        ...
                        }</Text><Text style={{fontSize: 12, color: 'gray'}}> Runs</Text></View>
                        <View style={{
                            flexDirection: 'row',
                            width: '25.9%',
                        ...
                        </Text><Text style={{fontSize: 12, color: 'gray'}}> Balls</Text></View>
                        <View style={{
                            flexDirection: 'row',
                            width: '25.9%',
                        ...
                        }</Text><Text style={{fontSize: 12, color: 'gray'}}> SR</Text></View>
                    </View>}
                </View>}
                {item && item['batsman_2'] && < View style={{
                    ...
                    {item['batsman_2']['player'].name && <View style={{
                        ...
                        flexDirection: 'row',
                        alignItems: 'center',
                    }}><Text style={{color: 'black'}}>{item['batsman_2']['player'].short_name}</Text>
