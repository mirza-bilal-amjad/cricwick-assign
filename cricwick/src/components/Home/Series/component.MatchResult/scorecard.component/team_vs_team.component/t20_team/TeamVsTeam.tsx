            ...
            <View style={[styles.teamABCont]}>
                <View style={[styles.teamA]}>
                    <View style={[styles.teamName_Flag]}>
                        <Text style={[styles.teamName]}>{item.team_1.team.short_name}</Text>
                    ...
                    <View style={[styles.teamScoreInfo, {
                        ...
                        {(item.format === 'T20i' || item.format === 'T20') ? odi_overs(team1[0]) : <></>}
                        {(item.format === 'T20i' || item.format === 'T20') ? odi_score(team1[0]) : <></>}
                    </View>
                </View>
                ...
                <View style={[styles.teamB]}>
                    ...
                    <View style={[styles.teamScoreInfo, {
                        ...
                        {(item.format === 'T20i' || item.format === 'T20') && odi_overs(team2[0])}
                        {(item.format === 'T20i' || item.format === 'T20') && odi_score(team2[0])}
                    </View>
                </View>
            </View>
