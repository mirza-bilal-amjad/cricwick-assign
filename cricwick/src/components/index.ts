...
export {default as NewsComponent} from './Home/Series/component/news';
export {default as ArticleComponent} from './Home/Series/component/article';
export {default as VideoComponent} from './Home/Series/component/videos';
//HomePage SubComponents
export {default as DateComponent} from './UnviversalComponent/DateComponent';
