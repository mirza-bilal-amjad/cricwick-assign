...
const AllRounders = ({item, index}: any) => {
    ...
    return (
        <View style={{
            ...
            <View style={{
                ...
                style={{color: colors.text, paddingHorizontal: 3, fontSize: 12, textAlign: 'right', right: 4}}>{index + 1}</Text></View>
            <View style={{
            ...
            <View style={{
                ...
                <Text
                    style={{color: colors.text, fontSize: 12, textAlign: 'center', left: 5}}>{item.team_name}</Text></View>
            <View style={{
